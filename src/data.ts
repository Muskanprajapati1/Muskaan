...
export const PRODUCTS: Product[] = [
  {
    ...
    description:
      "Deeply moisturizes and nourishes the skin to restore natural brightness and youthful suppleness.",
    benefits: [
...

  {
    ...
    description:
      "Reduces dark spots, evens skin tone, and protects against daily environmental stressors.",
    benefits: [
...

  {
    ...
    description:
      "Removes dirt, makeup, and daily impurities gently without stripping away primary skin moisture.",
    benefits: [
...

  {
    ...
    description:
      "Provides long-lasting moisture, creating an ultra-soft protective barrier that keeps lips hydrated day and night.",
    benefits: [
...

  {
    ...
    description:
      "Premium lightweight formula offering full buildable coverage with a flawless velvet finish.",
    benefits: [
...

  {
    ...
    description:
      "Broad-spectrum physical protection against UVA & UVB rays with a clean water-resistant formula.",
    benefits: [
...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    summary:
      "Healthy skin starts with cleansing, moisturizing, using sunscreen, staying hydrated, and maintaining a balanced diet.",
...
Supplement your skincare routine with nutrients. Foods rich in fatty acids, berries, leafy greens, and citrus promote collagen synthesis and fight free radicals from inside, giving you a natural glowing skin!`,
...

  {
    ...
    summary:
      "Vitamin C helps brighten the skin, reduce pigmentation, and protect against environmental damage.",
...
* Follow up with a locking moisturizer and SPF 50 sunscreen to stay shielded from UV radiation all day long!`,
...

  {
    ...
    summary:
      "Selecting a foundation that matches your undertone ensures a natural and flawless makeup look.",
...
Our **Matte Perfection Foundation** offers a lightweight, buildable mesh that self-adjusts seamlessly, preventing oxidization and dry-looking application lines.`,
...

  {
    ...
    summary:
      "Natural ingredients provide nourishment while reducing the risk of irritation and harmful side effects.",
    category: "Philosophy",
    date: "May 15, 2026",
    readTime: "6 min read",
...
At Glowvya, we promise that our formulas remain cruelty-free, skin-friendly, and eco-sustainable. We believe looking gorgeous should never demand compromising the beauty of our organic planet.`,
...

  {
    ...
    summary:
      "A proper morning skincare routine includes cleansing, applying serum, moisturizing, and using sunscreen for all-day protection.",
